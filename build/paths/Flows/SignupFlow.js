...
exports.signupFlow = void 0;
const __1 = require("../..");
const Resources_1 = require("../../components/Resources");
const ExpressApp_1 = require("../../components/ExpressApp");
const crypto_1 = __importDefault(require("crypto"));
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
function signupFlow(app) {
    app.post("/api/email/signup/registration", ExpressApp_1.CSRFToken, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield __1.prisma.email.findFirst({ where: { emailId: uniqueId } })
            .then((email) => __awaiter(this, void 0, void 0, function* () {
            if (!email) {
                email = yield __1.prisma.email.create({ data: {
                        emailId: uniqueId,
                        email: (0, ExpressApp_1.encript)(req.body.userEmail, uniqueId)
                    } });
            }
            let OTP = "";
            ...
            yield __1.prisma.sentMail.create({ data: {
                ...
                .then(() => {
                (0, Resources_1.sendMail)({ to: userEmail, title: "SabaiShare (Signup Link)", body: `
    ...
    app.get("/api/user/create/email/:mailId/:mailValue", (req, res) => __awaiter(this, void 0, void 0, function* () {
        let expiryDate = new Date();
        expiryDate.setDate(expiryDate.getDate() - 1);
        yield __1.prisma.sentMail.findFirst({ where: {
                ...
                type: { equals: "signup email" },
                sentDate: { gt: expiryDate }
            } }).then((sentMail) => __awaiter(this, void 0, void 0, function* () {
            if (!sentMail) {
                res.status(400).json({ message: "No registry found" });
                return;
            }
            yield __1.prisma.user.findFirst({
                ...
                res
                    .cookie(user ? "reRegistryEmail" : "registryEmail", jsonwebtoken_1.default.sign({ id: sentMail.emailId }, ExpressApp_1.jwtkey), { httpOnly: true, sameSite: "strict" })
                    .cookie("allowFill", "yes")
                    .status(200)
                    .redirect(`${req.protocol}://${req.get("host")}${user ? "/form/ReactivateAccount" : "/form/SignupForm"}`);
